...
function Add-Table($base, $headers, $definition) {
  ...
  Invoke-RestMethod -Method Post -Uri "$base/EntityDefinitions" -Headers $headers -ContentType 'application/json; charset=utf-8' -Body ($definition | ConvertTo-Json -Depth 12) | Out-Null
}
